...
$LANG_PERM_FILTER="Accès interdit. Il faut fournir un filtre.";
$LANG_GALLERIES="Galleries Picasa";
$LANG_GALLERY="Gallerie";
$LANG_IMAGES="images";
$LANG_PRIVATE="Privé";
$LANG_PUBLIC="Public";
$LANG_WHERE="Chemin d'accès";
$LANG_ACCESS="Accès";
$LANG_PHOTOS_IN="photos dans";
$LANG_ALBUMS="albums";
$LANG_BACK="retour à la liste des albums";
$LANG_PAGE="Page";
$LANG_GET="Obtenir";
$LANG_GENERATED="Page générée par";
?>
